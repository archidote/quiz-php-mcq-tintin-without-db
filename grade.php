...
<body>
	<div id="page-wrap">		
        <?php
            ...
            $_SESSION['totalCorrect'] = $totalCorrect; // Score de l'user dans une session, pour l'envois de celui-ci dans le mail et ou diplome.
            ...
            include 'whichTintin.php' // affichage d'un tintin random pour ojd parmis 28 
        	?>
	</div>
</body>
