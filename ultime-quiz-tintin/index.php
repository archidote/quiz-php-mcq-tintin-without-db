...
<head>
  ...
  <title>Tintin, l'ultime quiz</title>
	...
	<div class="bo-wrap clr3">
	  <div class="bo-footer">
	    <div class="bo-footer-smap">
	        <a href="https://fr.wikipedia.org/wiki/Liste_des_personnages_des_Aventures_de_Tintin" target="_blank">Les personnages</a> | <a href="https://www.museeherge.com/fr" target="_blank">Musée Hergé</a>
		</div>
		...
		<div class="bo-footer-power">
	        Tintin, <a href="http://tintin.com/" target="_blank">Site Officiel</a>
		</div>
    ...
    <script>
        alert("Salut, Les questions de ce quiz sont basés sur les 21 épisodes des aventures de Tintin (série télévisée d'animations - 1991), ainsi que sur le film d'animations Tintin et le lac aux requins. Vous disposez de 22 minutes dès à présent. Oubliez pas de remplir le formulaire Email-Nom-Prénom-Age. Bonne chance :)");
    </script>
    <script  src="./js/timerInMinutes.js"></script>
    <script  src="./js/sendFormAutomatically-php.js"></script>
    <script type="text/javascript"> /*
        document.getElementById("global").addEventListener("focusout", focusOutFunction);
        document.getElementById("global").addEventListener("focusin", focusInFunction);
